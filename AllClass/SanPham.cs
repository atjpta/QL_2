...
namespace QL_2.AllClass
{
    class SanPham
    {
        ...
        public SanPham(int id_nhan_vien, string malo, string ten_san_pham, string don_vi_tinh, int so_luong_ton_kho, byte[] img)
        {
        ...
        public SanPham(int id_san_pham, int id_nhan_vien, string malo, string ten_san_pham, string don_vi_tinh, int so_luong_ton_kho, byte[] img)
        {
